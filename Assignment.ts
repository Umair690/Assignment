...
let personal_name:string="Umair";
...
let favorite_number:number=15678;
...
let array:string []= ["Umair","Zubair","Shani","Haris"]
...
let sani:string []=["Umair","Zubair","Shani","Haris","Ali"]
...
let favoriteTransportation:string[]=["suzuki","Honda"]
...
let guestList:string[]=["Umair","Zubair","Shani"]
...
let GuestList:string[]= ["Umair","Zubair","Shani","Haris","Ali"]
...
let GuestList1:string[]=["Umair","Zubair","Shani","Haris","Ali"]
...
let favoriteLocation:string[]=["India","Iran","pakistan","Canada","Europe"]
...
let DinnerGuestList:string[]=["Umair","Zubair","Shani","Haris","Ali"]
...
let country:string[]=["pakistan","SA","America","UK","Bahrain"]
...
let identification=[{Name:"Umair",city:"sahiwal",Province:"punjab",phone:"095764456"},
{Name:"Ali",city:"sahiwal",Province:"punjab",phone:"095764456"},
...
let intentionError:string[]=["Sami","Umair","Tariq","Sameer"]
...
let current_user:string[]=["Umair","Zameer","Nasir","Ali"]
let new_user:string[]=["Salman","Kashif","Azeem","Alam"]
...
let b= city_Country("New York","US")
...
function magician(magician_show:string[]=["Umair","Aleem","Sami"]) {
...
sandwich("Turkish", "Mozrella");
sandwich("Russian Salad");